...
define("confluence-dashboard/utils/footer-analytics",["jquery","ajs"],function(a,e){"use strict";function t(a){return a&&a.__esModule?a:{default:a}}var o=t(a).default,n=t(e).default;n.toInit(function(){var a=n.Meta.get("page-id"),e=o("body").hasClass("dashboard");o("#footer").on("click","a",function(){n.trigger("analytics",{name:"confluence.footer.item.click",data:{pageId:a,isDashboard:e}})})})}),require(["confluence-dashboard/utils/footer-analytics"]);
}catch(e){WRMCB(e)};
;
try {
...
Confluence.Templates.Hipchat.Discovery.integrationDialog = function(opt_data, opt_ignored) {
  return '<h2>' + soy.$$escapeHtml("\u5c06\u60a8\u7684\u5408\u6d41\u7f51\u7ad9\u8fde\u63a5\u5230 HipChat") + '</h2><p>' + soy.$$escapeHtml("\u8BBE\u7F6E\u5E76\u53D1\u9001\u901A\u77E5\u5230 HipChat \u623F\u95F4\u3002") + '</p><br/><button class="aui-button" id="hipchat-integration-discovery-open">' + soy.$$escapeHtml("\u4e0e HipChat \u6574\u5408") + '</button><a href="#" style="padding-left: 20px" id="hipchat-integration-discovery-dismiss">' + soy.$$escapeHtml("\u4e0d\u662f\u73b0\u5728") + '</a>';
};
if (goog.DEBUG) {
...
Confluence.Templates.HipChat.Presence.chatBar = function(opt_data, opt_ignored) {
  return '<div class="hipchat-chatbar aui-buttons"><button class="aui-button hipchat-chat" title="' + soy.$$escapeHtml("\u56e0\u4e3a HipChat \u4e2d\u7684\u7528\u6237\u672a\u77e5\uff0c\u6240\u4ee5\u65e0\u6cd5\u5f00\u59cb\u804a\u5929\u3002") + '" aria-disabled="true"><span><span class="aui-icon aui-icon-small hipchat-icon-chat">' + soy.$$escapeHtml("\u804a\u5929") + '</span></span></button><button class="aui-button hipchat-voice" title="' + soy.$$escapeHtml("\u65e0\u6cd5\u5f00\u59cb\u8bed\u97f3\u547c\u53eb\uff0c\u56e0\u4e3a HipChat \u4e2d\u7684\u7528\u6237\u672a\u77e5\u3002") + '" aria-disabled="true" data-call-type="voice"><span><span class="aui-icon aui-icon-small hipchat-icon-voice">' + soy.$$escapeHtml("\u8bed\u97f3") + '</span></span></button><button class="aui-button hipchat-video" title="' + soy.$$escapeHtml("\u56e0\u4e3a HipChat \u4e2d\u7684\u7528\u6237\u672a\u77e5\uff0c\u6240\u4ee5\u65e0\u6cd5\u5f00\u59cb\u89c6\u9891\u901a\u8bdd\u3002") + '" aria-disabled="true" data-call-type="video"><span><span class="aui-icon aui-icon-small hipchat-icon-video">' + soy.$$escapeHtml("\u89c6\u9891") + '</span></span></button></div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Hipchat.Discovery.spaceIntegrationDialog = function(opt_data, opt_ignored) {
  return '<h2>' + soy.$$escapeHtml("\u53d1\u9001\u4fe1\u606f\u5230\u4e00\u4e2a HipChat \u623f\u95f4") + '</h2><p>' + soy.$$escapeHtml("\u76f4\u63a5\u4e3a\u65b0\u9875\u9762\u3001\u535a\u5ba2\u6587\u7ae0\u6216\u7a7a\u95f4\u53d8\u5316\uff0c\u53d1\u9001\u901a\u77e5\u5230 HipChat \u7684\u4e00\u4e2a\u623f\u95f4\u4e2d\u3002") + '</p><br/><button class="aui-button" id="hipchat-integration-discovery-open">' + soy.$$escapeHtml("\u6dfb\u52a0 HipChat \u901a\u77e5") + '</button><a href="#" style="padding-left: 20px" id="hipchat-integration-discovery-dismiss">' + soy.$$escapeHtml("\u4e0d\u662f\u73b0\u5728") + '</a>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Metadata.JIRA.metadata = function(opt_data, opt_ignored) {
  var output = '<div id="jira-metadata-dialog" class="rendered-content"><h2 class="title">' + soy.$$escapeHtml("JIRA\u94fe\u63a5") + '</h2><div class="items-section">';
...
Confluence.Templates.Metadata.JIRA.nometadata = function(opt_data, opt_ignored) {
  return '<div id="jira-metadata-dialog" class="rendered-content">' + aui.message.warning({content: '<p>' + soy.$$escapeHtml("\u4e0d\u80fd\u663e\u793aJIRA \u94fe\u63a5\uff0c\u6ca1\u6709\u6b63\u786e\u7684JIRA\u6743\u9650\u6216\u8005\u94fe\u63a5\u5df2\u88ab\u5220\u9664\u3002") + '</p>'}) + '</div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Metadata.JIRA.renderGroup = function(opt_data, opt_ignored) {
  ...
  for (var linkIndex130 = 0; linkIndex130 < linkListLen130; linkIndex130++) {
    ...
    output += '<li class="jira-metadata-item"><a href="' + soy.$$escapeHtml("/confluence") + '/plugins/servlet/jira-metadata/redirect?u=' + soy.$$escapeUri(linkData130.url) + '&t=' + soy.$$escapeHtml(opt_data.type) + '&more">' + soy.$$escapeHtml(AJS.format("\u5728 {1}\u4e2d\uff0c\u67e5\u770b\u66f4\u591a\u7684{0}",linkData130.numItems,linkData130.appName)) + '</a></li>';
  }
  output += '</ul></div>';
  return output;
};
...
Confluence.Templates.Metadata.JIRA.loadingMetadata = function(opt_data, opt_ignored) {
  return '<div id="jira-metadata-dialog"><h2 class="title">' + soy.$$escapeHtml("JIRA\u94fe\u63a5") + '</h2><div class="spinner-container"><div class="spinner"></div></div></div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Metadata.JIRA.renderJiraErrors = function(opt_data, opt_ignored) {
  ...
  if (opt_data.errors.length == 1) {
    ...
    output += aui.message.warning({content: '<p>' + soy.$$escapeHtml("\u4e0d\u80fd\u68c0\u7d22JIRA\u5143\u6570\u636e\u3002") + ' ' + soy.$$escapeHtml(error__soy150.errorMessage) + '</p>'});
...
Confluence.Templates.Metadata.JIRA.unknownError = function(opt_data, opt_ignored) {
  return '<div id="jira-metadata-dialog" class="rendered-content">' + aui.message.warning({content: '<p>' + soy.$$escapeHtml("\u4e0d\u80fd\u68c0\u7d22JIRA\u5143\u6570\u636e\uff0c\u4e0d\u80fd\u4e0eConfluence\u8fde\u63a5") + '</p>'}) + '</div>';
};
if (goog.DEBUG) {
...
var a=d.contextPath()+"/plugins/editor-loader/editor.action";return f=e.get(a,{parentPageId:h.get("parent-page-id"),pageId:h.get("page-id"),spaceKey:h.get("space-key"),atl_after_login_redirect:o.location.pathname,timeout:d.Confluence.EditorLoader.loadingTimeout})},resourcesLoaded:function(){return b&&b.isResolved()},loadingTimeout:12E3,isEditorActive:function(){var a=e("#editor-preload-container");return a.length&&a.is(":visible")},load:function(a,c){function f(){return n.require(["wrc!editor","wrc!macro-browser",
"wrc!fullpage-editor"]).fail(function(a){d.logError("Failed to load editor resources",a)})}var j;if(b){b.fail(function(){c?c.call(this,arguments):d.log("EditorLoader: loadGuard - previous load failed.")});b.done(function(){a?b.done(function(){setTimeout(a,0)}):d.log("EditorLoader: loadGuard - editor is already loaded.")});j=true}else j=void 0;if(!j){b=new e.Deferred;a&&b.done(a);c&&b.fail(c);var l=k();e("body").append(l);var i=new e.Deferred;h.get("page-id")?this.getEditorPreloadMarkup().always(function(a,
b,c){if(b==="success"||b==="notmodified"){l.append(a);a=d.renderTemplate("dynamic-editor-metadata");e("head").append(a);m.metaToParams();d.debug("EditorLoader: Finished loading the editor template.");i.resolve();g.debugTimeEnd("confluence.editor.preload")}else i.reject("Error loading the Editor template: "+c.status+" - "+c.statusText)}):i.resolve();i.pipe(f).done(function(){d.debug("EditorLoader: Finished loading the editor.");b.resolve()}).fail(function(){b.reject(arguments)})}},getEditorForm:function(){if(this.isEditorActive()){var a=
require("tinymce");return e(a.activeEditor.getContainer()).closest("form")}return null}}});require("confluence/module-exporter").exportModuleAsGlobal("confluence-editor-loader/editor-loader","AJS.Confluence.EditorLoader");
}catch(e){WRMCB(e)};
;
try {
...
Confluence.Templates.User.logo = function(opt_data, opt_ignored) {
  return '' + ((opt_data.profilePictureInfo['default'] && opt_data.username == opt_data.currentUsername) ? '<a ' + ((opt_data.canView) ? ' ' + ((! opt_data.disableUserHover) ? 'class="userLogoLink"' : '') + ' data-username="' + soy.$$escapeHtml(opt_data.username) + '"' : '') + ' href="' + soy.$$escapeHtml("/confluence") + '/users/profile/editmyprofilepicture.action" title="' + soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf") + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml("/confluence/s/zh_CN/7202/57e26a1771e14e3fb96fd7cebe99a87f17d4379c/_") + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml("\u7528\u6237\u56fe\u6807") + ': ' + soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf") + '"></a>' : (opt_data.profilePictureInfo.anonymous) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/confluence/s/zh_CN/7202/57e26a1771e14e3fb96fd7cebe99a87f17d4379c/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml("\u7528\u6237\u56fe\u6807") + ': ' + soy.$$escapeHtml("\u533f\u540d") + '" title="' + soy.$$escapeHtml("\u533f\u540d") + '">' : (opt_data.canView) ? '<a ' + ((! opt_data.disableUserHover) ? 'class="userLogoLink"' : '') + ' data-username="' + soy.$$escapeHtml(opt_data.username) + '" href="' + Confluence.Templates.User.userLinkUrl(opt_data) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml(opt_data.profilePictureInfo.uriReference) + '" alt="' + soy.$$escapeHtml("\u7528\u6237\u56fe\u6807") + ': ' + soy.$$escapeHtml(opt_data.username) + '" title="' + soy.$$escapeHtml(opt_data.username) + '"></a>' : '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/confluence/s/zh_CN/7202/57e26a1771e14e3fb96fd7cebe99a87f17d4379c/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml("\u7528\u6237\u56fe\u6807") + ': ' + soy.$$escapeHtml(opt_data.username) + '" title="' + soy.$$escapeHtml(opt_data.username) + '">');
};
if (goog.DEBUG) {
...
Confluence.Templates.Captcha.image = function(opt_data, opt_ignored) {
  return '<img src="' + soy.$$escapeHtml("/confluence") + '/jcaptcha?id=' + soy.$$escapeHtml(opt_data.captchaId) + '" class="captcha-image" alt="' + soy.$$escapeHtml("\u9a8c\u8bc1\u7801\u56fe\u7247") + '"><input type="hidden" name="captchaId" value="' + soy.$$escapeHtml(opt_data.captchaId) + '" placeholder="' + soy.$$escapeHtml("\u8f93\u5165\u4e0a\u9762\u7684\u6587\u5b57") + '">';
};
if (goog.DEBUG) {
...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_ignored) {
  return '<p class="comment-user-logo">' + ((opt_data.userInfo.userName == null) ? '<img class="userLogo logo anonymous" src="' + soy.$$escapeHtml("/confluence/s/zh_CN/7202/57e26a1771e14e3fb96fd7cebe99a87f17d4379c/_") + '/images/icons/profilepics/anonymous.png" alt="' + soy.$$escapeHtml("\u7528\u6237\u56fe\u6807") + ': ' + soy.$$escapeHtml("\u533f\u540d") + '" title="' + soy.$$escapeHtml("\u533f\u540d") + '">' : (opt_data.userInfo.profilePicture.isDefault) ? '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + soy.$$escapeHtml("/confluence") + '/users/profile/editmyprofilepicture.action" title="' + soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf") + '"><img class="userLogo logo defaultLogo" src="' + soy.$$escapeHtml("/confluence/s/zh_CN/7202/57e26a1771e14e3fb96fd7cebe99a87f17d4379c/_") + '/images/icons/profilepics/add_profile_pic.png" alt="' + soy.$$escapeHtml("\u7528\u6237\u56fe\u6807") + ': ' + soy.$$escapeHtml("\u6dfb\u52a0\u5934\u50cf") + '"></a>' : '<a class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" href="' + Confluence.Templates.User.userLinkUrl({username: opt_data.userInfo.userName}) + '"><img class="userLogo logo" src="' + soy.$$escapeHtml(opt_data.userInfo.profilePicture.path) + '" alt="' + soy.$$escapeHtml("\u7528\u6237\u56fe\u6807") + ': ' + soy.$$escapeHtml(opt_data.userInfo.userName) + '" title="' + soy.$$escapeHtml(opt_data.userInfo.userName) + '"></a>') + '</p>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Comments.commentView = function(opt_data, opt_ignored) {
  return '<div class="comment' + ((opt_data.highlight == true) ? ' focused' : '') + '" id="comment-' + soy.$$escapeHtml(opt_data.comment.id) + '">' + Confluence.Templates.Comments.userLogo({userInfo: opt_data.commenter}) + '<div class="comment-header"><h4 class="author">' + ((opt_data.commenter.userName == null) ? soy.$$escapeHtml("\u533f\u540d\u7528\u6237") : '<a href="' + soy.$$escapeHtml("/confluence") + '/display/~' + soy.$$escapeUri(opt_data.commenter.userName) + '" class="url fn confluence-userlink" data-username="' + soy.$$escapeHtml(opt_data.commenter.userName) + '">' + soy.$$escapeHtml(opt_data.commenter.displayName) + '</a>') + '</h4></div><div class="comment-body"><div class="comment-content wiki-content">' + soy.$$filterNoAutoescape(opt_data.comment.html) + '</div><div class="comment-actions">' + Confluence.Templates.Comments.displayCommentActions({section: 'secondary', actions: opt_data.comment.secondaryActions, commentId: opt_data.comment.id}) + Confluence.Templates.Comments.displayCommentActions({section: 'primary', actions: opt_data.comment.primaryActions, commentId: opt_data.comment.id}) + '</div></div></div>';
};
if (goog.DEBUG) {
...
a=e.inArray(a,f);if(a>=0){f.splice(a,1);return false}return true})},render:function(f){g.setCount(g.getCount()+f.length);var f={close:"manual",type:"info",extraClasses:"qr-flag",fifo:true,stack:"quickreload"},j=this.results.length>1?h.format("{0}\u6761\u65b0\u8bc4\u8bba",this.results.length):"\u65b0\u8bc4\u8bba",b;b=c.clone(this.results);b.reverse();b=c.uniq(b,function(a){return a.commenter.userName});b=c.map(b,function(a){return a.commenter});var l=e("<div>").html(this.results[this.results.length-
...
e.$form.show();e.$form.addClass("fadeIn");var d=e.editor,f=e.content?e.content.editorContent:"",g=e.replayBufferedKeys;if(f){d.setContent(f);d.startContent=d.getContent({format:"raw",no_events:1});d.undoManager.clear()}g()&&d.undoManager.add();b.trigger("quickedit.success");b.trigger("quickedit.visible");b.trigger("add-bindings.keyboardshortcuts");b.trigger("active.dynamic.rte");c("div.aui-message.closeable").each(function(){var a=c(this),d;if(!a.find(".icon-close").length){d=c('<span class="aui-icon icon-close" role="button" tabindex="0"></span>').click(function(){a.closeMessage()}).keypress(function(c){if(c.which===
b.keyCode.ENTER||c.which===b.keyCode.SPACE){a.closeMessage();c.preventDefault()}});a.append(d)}});a.postInitialise&&a.postInitialise(e);n.SaveBarBinder.bind(a.saveHandler,a.cancelHandler);b.trigger("rte-quick-edit-ready");d=i.get("content-type");i.get("collaborative-content")&&(d==="page"||d==="blogpost")&&b.trigger("rte-collab-editor-loaded");b.unbind("rte-ready",h);j.resolve()};b.bind("rte-ready",h);b.bind("rte-destroyed",a.postDeactivate||function(){});b.Rte.BootstrapManager.initialise({plugins:a.plugins,
...
return j.promise()}if(a.closeAnyExistingEditor&&b.Rte&&b.Rte.getEditor()){var f=new c.Deferred;this.deactivateEditor().done(function(){d().done(function(){f.resolve()}).fail(function(a){f.reject(a)})}).fail(function(){b.debug("Could not deactivate current editor.");f.reject("Could not deactivate current editor.")});return f.promise()}return d()},deactivateEditor:function(){require("tinymce").execCommand("mceRemoveControl",true,"wysiwygTextarea");d.Editor.UI.toggleSavebarBusy(false);var a=b.Confluence.EditorLoader.getPreloadContainer().empty();
c(".editor-container").remove();c("#editor-precursor").remove();c("#anonymous-warning").remove();c(".quick-comment-prompt").show();c(".bottom-comment-panels").show();c("#editor-notification-container").empty();c(".action-reply-comment").removeAttr("reply-disabled");o.enableShortcut();d.Editor.removeAllSaveHandlers();d.Editor.removeAllCancelHandlers();return b.Confluence.EditorLoader.getEditorPreloadMarkup().done(function(c){a.append(c);a.hide();(new b.Confluence.QuickEditCaptchaManager(a)).refreshCaptcha();
b.trigger("rte-destroyed");b.unbind("rte-destroyed")})}};return n});require("confluence/module-exporter").exportModuleAsGlobal("confluence-quick-edit/quick-edit","AJS.Confluence.QuickEdit");
}catch(e){WRMCB(e)};
;
try {
...
i.activateEditor();a=c("#editPageLink");a.find(".aui-icon").css("visibility","hidden");a.parent().spin({left:"10px"})}}},enable:function(){if(c("body").is(".theme-default")){var a=c("#editPageLink");a.bind("click",i.activateEventHandler);a.removeClass("full-load");i.editShortcut.bind();b.debug("QuickPageEdit enabled")}else b.debug("QuickPageEdit not enabled")},activateEditor:function(){g.debugTime("confluence.editor");o()&&b.trigger("rte-quick-edit-init");var a=c("#content").find(".quick-comment-form"),
e=function(){var a=require("tinymce").activeEditor.getWin(),d=c(a.document).find("#tinymce");if(a=p(d,a.pageYOffset,b.params.pageId))sessionStorage.viewPort=JSON.stringify(a)};return b.Confluence.QuickEdit.activateEditor({fetchContent:B(),$container:c("#content"),$form:a.length?a:c('<form method="post"></form>'),preInitialise:y,postInitialise:z,saveHandler:function(){b.DarkFeatures.isEnabled("confluence.view.edit.transition")&&e();g.Editor.getNumConcurrentEditors()>1&&b.Confluence.Analytics.publish("rte.notification.concurrent-editing.save",
{numEditors:g.Editor.getNumConcurrentEditors(),pageId:b.params.pageId,draftType:b.params.draftType})},cancelHandler:function(){b.DarkFeatures.isEnabled("confluence.view.edit.transition")&&e();g.Editor.getNumConcurrentEditors()>1&&b.Confluence.Analytics.publish("rte.notification.concurrent-editing.cancel",{numEditors:g.Editor.getNumConcurrentEditors(),pageId:b.params.pageId,draftType:b.params.draftType})},plugins:b.Confluence.Editor._Profiles.createProfileForPageEditor({versionComment:true,notifyWatchers:true}).plugins,
onInitialise:function(a){b.DarkFeatures.isEnabled("confluence.view.edit.transition")&&a.onLoad.add(A)}}).fail(r)},disable:function(){b.debug("QuickPageEdit disabled.");i.editShortcut.unbind();c("#editPageLink").unbind("click",i.activateEventHandler)}};b.Confluence.QuickEdit.register(i);return{disable:i.disable,_objForTesting:{onFailActivateEditor:r}}});require("confluence/module-exporter").exportModuleAsGlobal("confluence-quick-edit/handlers/page","AJS.Confluence.QuickEdit.QuickEditPage");
}catch(e){WRMCB(e)};
;
try {
...
;
try {
/* module-key = 'net.kentcom.page-view-tracker:page-view-tracker-resources', location = '/soy/page-view.soy' */
// This file was automatically generated from page-view.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace PageViewTracker.Templates.Soy.
 */

if (typeof PageViewTracker == 'undefined') { var PageViewTracker = {}; }
if (typeof PageViewTracker.Templates == 'undefined') { PageViewTracker.Templates = {}; }
if (typeof PageViewTracker.Templates.Soy == 'undefined') { PageViewTracker.Templates.Soy = {}; }


PageViewTracker.Templates.Soy.showPageTracker = function(opt_data, opt_ignored) {
  return '<!-- Render the dialog --><section role="dialog" id="page-view-tracker-dialog" class="aui-layer aui-dialog2" style="width:820px;" data-aui-modal="true" aria-hidden="true"><!-- Dialog header --><header class="aui-dialog2-header"><!-- The dialogs title --><h2 class="aui-dialog2-header-main">' + soy.$$escapeHtml("Page View Statistics") + '</h2></header><!-- Main dialog content --><div class="aui-dialog2-content" id="page-view-tracker-content" style="height:400px; overflow-y: scroll;"></div><!-- Dialog footer --><footer class="aui-dialog2-footer"><!-- Actions to render on the right of the footer --><div class="aui-dialog2-footer-actions"><button id="page-view-tracker-help" class="aui-button aui-button-link">' + soy.$$escapeHtml("Help") + '</button><button id="page-view-tracker-close" class="aui-button aui-button-link">' + soy.$$escapeHtml("Close") + '</button></div></footer></section>';
};
if (goog.DEBUG) {
  PageViewTracker.Templates.Soy.showPageTracker.soyTemplateName = 'PageViewTracker.Templates.Soy.showPageTracker';
}

}catch(e){WRMCB(e)};
;
try {
/* module-key = 'net.kentcom.page-view-tracker:page-view-tracker-resources', location = '/js/page-view.js' */
AJS.toInit(function(){AJS.$("#main-content").before(PageViewTracker.Templates.Soy.showPageTracker());var a=AJS.params.baseUrl+"/plugins/servlet/pageViewTracker/getPageStats";AJS.$("#page-view-tracker-action").click(function(c){$.ajax({type:"GET",url:a,data:{pageId:AJS.params.pageId,action:"All",timezone:Intl.DateTimeFormat().resolvedOptions().timeZone,},success:function(d){console.log(d);$("#page-view-tracker-content").html(d);AJS.tablessortable.setTableSortable(AJS.$("#page-view-tracker-table"));AJS.tabs.setup();AJS.dialog2("#page-view-tracker-dialog").show();$("#page-view-tracker-close").focus()},error:function(d){console.log(d)}});c.preventDefault()});$(document).on("change","#page-view-tracker-page-history",function(c){$.ajax({type:"GET",url:a,data:{pageId:AJS.params.pageId,action:"PageHistory",range:$(this).prop("value"),timezone:Intl.DateTimeFormat().resolvedOptions().timeZone,},success:function(d){console.log(d);$("#tab-page-view-page-history").html(d)}});c.preventDefault()});$(document).on("change","#page-view-tracker-space-history",function(c){$.ajax({type:"GET",url:a,data:{pageId:AJS.params.pageId,action:"SpaceHistory",range:$(this).prop("value"),timezone:Intl.DateTimeFormat().resolvedOptions().timeZone,},success:function(d){console.log(d);$("#tab-page-view-space-history").html(d)}});c.preventDefault()});var b;$(document).on("click",".page-view-user-link",function(c){$.ajax({type:"GET",url:a,data:{pageId:AJS.params.pageId,action:"UserHistory",userKey:$(this).attr("key"),timezone:Intl.DateTimeFormat().resolvedOptions().timeZone,},success:function(d){console.log(d);b=$("#tab-page-view-users").html();$("#tab-page-view-users").html(d)}});c.preventDefault()});$(document).on("click","#page-view-tracker-back",function(c){$("#tab-page-view-users").html(b);c.preventDefault()});AJS.$("#page-view-tracker-close").click(function(c){c.preventDefault();AJS.dialog2("#page-view-tracker-dialog").hide();location.href="#"});AJS.$("#page-view-tracker-help").click(function(c){c.preventDefault();window.open("https://ossapps.atlassian.net/wiki/spaces/PVT/overview","_blank")})});
}catch(e){WRMCB(e)};
;
try {
...
require(["ajs","wrm"],function(b,a){b.toInit(function(){a.require(["wrc!request-access-plugin"])})});
}catch(e){WRMCB(e)};
;
try {
...
navlinks.templates.appswitcher_old.suggestionApps = function(opt_data, opt_ignored) {
  return '<ul class=\'nav-links suggestion-apps\'><li><span class=\'app-discovery-suggest-title nav-link-label\'><h6>' + soy.$$escapeHtml("\u5c1d\u8bd5\u5176\u5b83Atlassian\u7684\u5e94\u7528") + '</h6></span></li></ul><div class=\'buttons-container app-discovery-suggest-apps-buttons\'><div class=\'buttons\'><button class=\'aui-button aui-button-link app-discovery-cancel-button\' name=\'cancel\' accesskey=\'c\' href=\'#\'>' + soy.$$escapeHtml("\u4e0d\u518d\u663e\u793a") + '</button></div></div>';
};
if (goog.DEBUG) {
